...
* rake git:branch:staging - Branch origin/staging into BRANCH locally.
* rake git:merge:production - Push changes from local production branch to origin/production and merge changes with master
* rake git:merge:staging - Push changes from local staging branch to origin/staging and merge changes with master
